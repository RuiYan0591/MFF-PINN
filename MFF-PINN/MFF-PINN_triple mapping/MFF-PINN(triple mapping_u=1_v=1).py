...
net = dde.nn.STMsFFN(layer_size, activation, initializer, sigmas_x=[1], sigmas_t=[1,30])#To change
...
losshistory, train_state = model.train(epochs = 0, display_every = 1, callbacks = [pde_residual_resampler],model_restore_path = r"sigma10.30_u1_v1_10000epochs")#To change
...
np.savetxt("VIV_sigma10.30_10000epochs_ξ0.5.txt", R_nn)
...
np.savetxt("Yuntu_sigma10.30_u1_v1_10000epochs.txt", R)
np.savetxt("Yuntu_sigma10.30_u1_v1_10000epochs_true.txt", R1)
