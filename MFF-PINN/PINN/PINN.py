...
net = dde.nn.FFN(layer_size, activation, initializer)
...
losshistory, train_state = model.train(epochs = 0, display_every = 1, callbacks = [pde_residual_resampler],model_restore_path = r"PINN_10000epochs")
...
np.savetxt("VIV_PINN_10000epochs_ξ0.5.txt", R_nn)
...
np.savetxt("Yuntu_PINN_u1_v1_10000epochs.txt", R)
np.savetxt("Yuntu_PINN_u1_v1_10000epochs_true.txt", R1)
